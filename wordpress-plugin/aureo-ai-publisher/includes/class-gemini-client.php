...
class Aureo_AI_Gemini_Client {
    ...
    public static function generate_article( $niche, $custom_instructions = "" ) {
        ...
        $prompt_lines = array(
            "You are a world-class senior architecture curator, luxury real estate analyst, and editorial writer.",
            ...
            '  "image_keyword": "Specific search term for an architectural or business image",',
